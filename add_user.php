...
if (isset($_POST['phone'])) {
    ...
    $userexiest = "SELECT * FROM `user-regester` WHERE phone = '$phone'";

    $usersql = mysqli_query($con, $userexiest);

    $userquery = mysqli_num_rows($usersql);

    if ($userquery > 0) {
        $usererror = '<div class="alert alert-danger" role="alert">
        phone number is already exist please use another phone number to sign up
      </div>';
    } else {
        $sql = "INSERT INTO `user-regester` (`phone`, `name`, `password`, `email`, `address`, `date`) VALUES ('$phone', '$name', '$password1', '$email', '$address', current_timestamp());";
        // echo $sql;
            ...
            <div class="py-4 text-gray-500 dark:text-gray-400">
                ...
                <ul>
                    ...
                    <li class="relative px-6 py-3">
                        ...
                        <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100" href="add_user.php">
                    ...
                    <main class="form-signin">
                        <form method="POST" action="add_user.php">
                            ...
                            <div class="form-floating mb-2">
                                <input type="number" class="form-control" id="floatingInput" placeholder="name@example.com" name="phone">
